...
| -- | --- | ---- | ----------- |
| RIZKY AMALIA PUTRI | TI.20.A.2 | 312010370 | Bahasa Pemrograman |

## Latihan
# Untuk latihan kali ini merubah # labspy6
## Tugas Melengkapi Pertemuan 10
| Nama | kelas | Nim # labspy6
## Tugas Melengkapi Pertemuan 10
| Nama | kelas | Nim | Matkul |
| -- | --- | ---- | ----------- |
| RIZKY AMALIA PUTRI | TI.20.A.2 | 312010370 | Bahasa Pemrograman |
 ...
 * Selain tugas latihan yang diberikan oleh dosen, saya juga diberi tugas praktikum oleh Dosen. Yaitu membuat progam sederhana menggunakan fungsi. Yang menampilkan Data Mahasiswa.  
 ...
 ![hasil](isi%20foto/SOAL%20CUY.png)
...
Setelah user memilih data, Misalnya user ingin merubah NIM dari mahasiswa dengan nama lia , Maka akan muncul tampilan seperti ini :
...
Sebelum saya menjalankan fitur ini, saya akan menambahkan 1 data lagi dengan nama lia
